...
if (-not (Test-Path $InstallerPath)) {
    ...
    Write-Host "[INFO] Using existing bootstrapper: $InstallerPath" -ForegroundColor Cyan
}
...
if ($installProcess.ExitCode -eq 0) {
    Write-Host "[OK] SQL Server Express installation completed successfully." -ForegroundColor Green
} else {
